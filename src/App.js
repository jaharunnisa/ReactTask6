...
import './App.css';
import abhiImage from "./jaharunnisa.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Jaharunnisa" />
          <h3 className="name">Jaharunnisa</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Jaharunnisa</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Jaharunnisa</h3>
            ...
            <h3> <span> Hobbies: </span>Art,crafting</h3>
            <h3> <span> Language : </span> Telugu, Hindi, English, urdu </h3>
          </div>
        </div>
      </section>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Sravanti High School</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> jaharunnisa.21bce9586@vitapstudent.ac.in</h3>
              <h3> <i className="fas fa-phone"></i> 6309076865 </h3>
